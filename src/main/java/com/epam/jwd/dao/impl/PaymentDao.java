...
public class PaymentDao implements Dao<Payment, Integer> {
    ...
    /**
     *
     * @param entity payment to be saved
     * @return payment with id generated by database, null if saving was unsuccessful
     */
    @Override
     ...
     * @param entity payment to be updated
     ...
     * @param entity payment to be deleted
     ...
     * @return payments with provided id, null if there is no payments with provided id
     */
    @Override
     ...
     *
     * @param id id of user
     * @return number of payments with userId == id
     */
     ...
     *
     * @param id id of user
     * @return list of payments where userId == id, empty list if there are no such payments
     */
     ...
     * @param limit amount of credit cards
     * @param offset offset from start of list in database
     * @return list of payments ordered by name
     */
     ...
     * @param limit amount of credit cards
     * @param offset offset from start of list in database
     * @return list of payments ordered by price
     */
     ...
     * @param limit amount of credit cards
     * @param offset offset from start of list in database
     * @return list of payments ordered by destination address
     */
     ...
     * @param limit amount of credit cards
     * @param offset offset from start of list in database
     * @return list of payments ordered by transaction time
     */
     ...
     * @param limit amount of credit cards
     * @param offset offset from start of list in database
     * @return list of payments ordered by committed
     */
     ...
     * @param limit amount of credit cards
     * @param offset offset from start of list in database
     * @return list of payments ordered by id
     */
     ...
     * @param limit amount of credit cards
     * @param offset offset from start of list in database
     * @return list of payments ordered by user id
     */
