...
public class AccountDao implements Dao<Account, Integer> {
    ...
    /**
     *
     * @param entity account to be saved
     * @return saved account with id generated by database, null if saving was unsuccessful
     */
    @Override
     ...
     * @param entity account to be updated
     ...
     * @param entity account to be deleted
     ...
     * @return account with provided id, null if there is no account with provided id
     */
    @Override
