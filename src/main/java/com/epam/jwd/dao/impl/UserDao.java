...
public class UserDao implements Dao<User, java.lang.Integer> {
     ...
     * @return user with id generated by database, null if saving was unsuccessful
     */
    @Override
     ...
     *
     * @param id id of user
     * @return user with provided id, null if there is no user with provided id
     */
    @Override
     ...
     * @return user with provided login, null if there is no user with provided login
     */
