...
public enum ExceptionCode {
    ...
    OPERATION_IS_NOT_SUPPORTED_EXCEPTION_CODE(3),
    ...
    USER_LOGIN_TOO_LONG_EXCEPTION_CODE(113),
    USER_PASSWORD_TOO_LONG_EXCEPTION_CODE(114),
    USER_LOGIN_CONTAINS_FORBIDDEN_CHARACTERS_EXCEPTION_CODE(115),
    USER_PASSWORD_CONTAINS_FORBIDDEN_CHARACTERS_EXCEPTION_CODE(116),
    ACCOUNT_NAME_TOO_LONG_EXCEPTION_CODE(117),
    ACCOUNT_SURNAME_TOO_LONG_EXCEPTION_CODE(118),
    ACCOUNT_NAME_CONTAINS_FORBIDDEN_CHARACTERS_EXCEPTION_CODE(119),
    ACCOUNT_SURNAME_CONTAINS_FORBIDDEN_CHARACTERS_EXCEPTION_CODE(120),
    USER_WAS_NOT_CREATED_EXCEPTION_CODE(121),
    ACCOUNT_WAS_NOT_CREATED_EXCEPTION_CODE(122),
    ...
    CREDIT_CARD_NUMBER_IS_NOT_UNIQUE_EXCEPTION_CODE(209),
    CREDIT_CARD_USER_ID_IS_NULL_EXCEPTION_CODE(210),
    CREDIT_CARD_NAME_TOO_SHORT_EXCEPTION_CODE(211),
    CREDIT_CARD_NAME_TOO_LONG_EXCEPTION_CODE(212),
    CREDIT_CARD_NAME_CONTAINS_FORBIDDEN_CHARACTERS_EXCEPTION_CODE(213),
    CREDIT_CARD_NUMBER_IS_ILLEGAL_EXCEPTION_CODE(209),
    CREDIT_CARD_WAS_NOT_CREATED(210),
    ...
    PAYMENT_NAME_TOO_LONG_EXCEPTION_CODE(411),
    PAYMENT_ADDRESS_TOO_SHORT_EXCEPTION_CODE(412),
    PAYMENT_ADDRESS_TOO_LONG_EXCEPTION_CODE(413),
    PAYMENT_NAME_CONTAINS_FORBIDDEN_CHARACTERS_EXCEPTION_CODE(414),
    PAYMENT_ADDRESS_CONTAINS_FORBIDDEN_CHARACTERS_EXCEPTION_CODE(415),
    PAYMENT_WAS_NOT_CREATED(416),

    PROFILE_PICTURE_IS_NOT_FOUND_EXCEPTION_CODE(502);
