...
public class ProfilePictureDao implements Dao<ProfilePicture, Integer> {
    ...
    /**
     *
     * @param entity profile picture to be saved
     * @return profile picture with id generated by database, null if saving was unsuccessful
     */
    @Override
     ...
     * @param entity profile picture to be updated
     ...
     * @param entity profile picture to be deleted
    ...
    /**
     *
     * @return list of all profile pictures
     */
    @Override
     ...
     * @return profile picture with provided id, null if there is no profile picture with provided id
     */
    @Override
    ...
    /**
     *
     * @return number of profile pictures
     */
    @Override
