        ...
        <c:if test="${requestScope.payments.size() > 0}">
            ...
            <c:if test="${requestScope.currentPage == 1 && requestScope.lastPage != 1}">
                <nav>
                    <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item">
                            <a class="page-link" href="/payments?command=show_admin_payments&currentPage=2">2</a>
                        </li>
                        <li class="page-item">
                            <a class="page-link" href="/payments?command=show_admin_payments&currentPage=${requestScope.lastPage}">Last</a>
                        </li>
                    </ul>
                </nav>
            </c:if>
            ...
            <c:if test="${requestScope.currentPage == requestScope.lastPage && requestScope.lastPage != 1}">
                <nav>
                    <ul class="pagination justify-content-center">
                        <li class="page-item">
                            <a class="page-link" href="/payments?command=show_admin_payments&currentPage=1">First</a>
                        </li>
                        <li class="page-item">
                            <a class="page-link" href="/payments?command=show_admin_payments&currentPage=${requestScope.lastPage-1}">${requestScope.lastPage-1}</a>
                        </li>
                        <li class="page-item active" aria-current="page">
                            <a class="page-link" href="/payments?command=show_admin_payments&currentPage=${requestScope.lastPage}">${requestScope.lastPage}</a>
                        </li>
                        <li class="page-item disabled">
            ...
            <c:if test="${requestScope.currentPage > 1 && requestScope.currentPage < requestScope.lastPage}">
                <nav>
                    <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item">
                            <a class="page-link" href="/payments?command=show_admin_payments&currentPage=${requestScope.currentPage-1}">${requestScope.currentPage-1}</a>
                        </li>
                        <li class="page-item active" aria-current="page">
                            <a class="page-link" href="/payments?command=show_admin_payments&currentPage=${requestScope.currentPage}">${requestScope.currentPage}</a>
                        </li>
                        <li class="page-item">
                            <a class="page-link" href="/payments?command=show_admin_payments&currentPage=${requestScope.currentPage+1}">${requestScope.currentPage+1}</a>
                        </li>
